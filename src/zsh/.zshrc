...
source "${HOME}/.config/zshrc/external/go.zsh"
...
source "${HOME}/.config/zshrc/external/rbenv.zsh"
source "${HOME}/.config/zshrc/external/ripgrep.zsh"
source "${HOME}/.config/zshrc/external/rust.zsh"
